...
app_formatage <- function() {
        ...
        tabItem(
          ...
          div(class = "card-deck",
              ...
              div(class = "card-body",
                ...
                div(class = "card-footer", icon("exclamation-triangle"),
  ...
  server = function(input, output, session) {
    ...
    observeEvent(input$validate_colonnes, {
      ...
      if (sum(widths) > 83  & input$format == "chiffres_et_donnees") {
    ...
    output$enreg <- downloadHandler(
      ...
      content = function(file) {
        ...
        if (is_error & length(input$upload_plan) == 0) {
          shinyalert("Veuillez vérifier les colonnes et les unités de chaque tableau.", type = "error")
        } else {
