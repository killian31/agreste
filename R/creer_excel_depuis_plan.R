...
#' CrÃ©e un classeur et le formate
#'
#' Cette fonction permet de formater tous les tableaux d'un classeur selon le type de publication choisi, simplement Ã  partir d'un plan. Les fichiers indiquÃ©s dans le plan doivent Ãªtre dans le rÃ©pertoire de travail.
#'
#' @param plan fichier .xlsx ou data frame contenant les dÃ©tails pour chaque tableau 
#' @param format CHAR le type de publication : "chiffres_et_donnees" ou "primeur"
#' @param type_virgule CHAR le type de sÃ©paration dÃ©cimale utilisÃ©e : "." ou ","
...
#' @param path CHAR chemin vers le tableau Ã  sauvegarder
#'
#' @return un objet de type workbook formatÃ©
#' 
